...
def value_of_ace(card_one, card_two):
    ...
    for index, num in enumerate(card_values):
        if num == 1:
...
def can_split_pairs(card_one, card_two):
    ...
    """
    if len(set((value_of_card(card_one), value_of_card(card_two)))) == 1:
        return True
    return False
...
def can_double_down(card_one, card_two):
    ...
    """
    if sum([value_of_card(card_one), value_of_card(card_two)]) in [9, 10, 11]:
        return True
    return False
